...
int KD_TREE<PointType>::Add_Points(PointVector &PointToAdd, bool downsample_on)
{
    ...
    int tree_size = size();
    // std::cout << "降采样前的点云数量: " << tree_size << std::endl;
    BoxPointType Box_of_Point;
    PointType downsample_result, mid_point;
    // bool downsample_switch = downsample_on && DOWNSAMPLE_SWITCH;//become false
    bool downsample_switch = downsample_on && false;//become false
